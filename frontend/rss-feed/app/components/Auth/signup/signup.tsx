...
export default function SignUpForm() {
  ...
  const validateForm = () => {
    let isValid = true;
    const newErrors = { username: '', email: '', password: '', repeatPassword: '', general: '' };
      ...
      <div className={styles.loginCard}>
        ...
        <div className={styles.loginRight}>
          <div className={styles.socialButtons}>
            <button type="button" className={`${styles.socialButton} ${styles.googleButton}`} onClick={handleGoogleSignIn}>
              <Image 
                src="/google-icon.svg" 
                alt="Google icon"
                width={20}
